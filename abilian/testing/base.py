...
class BaseTestCase(TestCase):
    ...
    #: rationale is that it improves code quality (for example most frequent
    #: warnings are non-Unicode string assigned on a Unicode column;
    #: this setting forces you to be explicit and ensure Unicode where
    #: appropriate).
    ...
    #: set to False to use cryptographic scheme (standard) for user password.
    #: By default the testcase switches to clear text to avoid longer running.
    ...
    def get_setup_config(self):
        ...
        :return: an instance of :attr:`config_class`, or anything that is a
            valid config object for Flask.
        """
